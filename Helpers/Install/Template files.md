...
-> This folder contains sandbox data for Debug mode. Creating a local copy of it is optional, because the app will init an empty repo if does not find any. Only that case, the DeveloperRepo will be empty.