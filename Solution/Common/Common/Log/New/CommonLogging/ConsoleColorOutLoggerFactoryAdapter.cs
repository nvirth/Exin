...
namespace Common.Log.New.CommonLogging
{
    ...
    public class ConsoleColorOutLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
    {
        ...
        /// settings.
        /// </summary>
        public ConsoleColorOutLoggerFactoryAdapter()
            : base(null)
        { }
        ...
        public ConsoleColorOutLoggerFactoryAdapter(NameValueCollection properties)
            : base(properties)
        { }
        ...
        /// </summary>
        public ConsoleColorOutLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat)
        ...
        /// default settings for the loggers created by this factory.
        /// </summary>
        public ConsoleColorOutLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat, bool useColor)
        ...
        {
            ILog log = new ConsoleColorOutLogger(name, level, showLevel, showDateTime, showLogName, dateTimeFormat, this.useColor);
            return log;
        }
    }
}