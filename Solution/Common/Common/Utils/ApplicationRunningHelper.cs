...
using Log = Exin.Common.Logging.Core.Log;
	...
	public static void SwitchToRunningInstanceIfExists()
	{
		...
		*/
		...
		if (runningInstance != null)
		{
			...
			Log.Info(typeof(ApplicationRunningHelper), m => m("----------------------------------------------------------------"));
			Log.Info(typeof(ApplicationRunningHelper), m => m("Closing this instance, switching to another, already running one"));
			Log.Info(typeof(ApplicationRunningHelper), m => m("----------------------------------------------------------------"));
