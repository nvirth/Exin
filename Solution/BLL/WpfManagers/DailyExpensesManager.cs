...
namespace BLL.WpfManagers
{
	public class DailyExpensesManager : SummaryEngineBase
	{
		...
		private void ReplaceDailyExpenses()
		{
			...
			{
				Log.Error(this,
					m => m(Localized.ResourceManager, LocalizedKeys.The_saving_of_the_daily_expenses_was_unsuccessful_),
					LogTarget.All,
					e
				);
				throw;
		...
		private void ReplaceSummary()
		{
			...
			{
				Log.Error(this,
					m => m(Localized.ResourceManager, LocalizedKeys.The_saving_of_expense_statistics_was_unsuccessful_),
					LogTarget.All,
					e
				);
				throw;
